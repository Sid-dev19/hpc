-- Supabase Schema Creation Script (Clean Install)
-- This script creates all tables without trying to drop existing ones
...
CREATE TABLE IF NOT EXISTS lo_rubric_descriptors (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS part_a_students (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS part_a4_parents (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    student_id UUID REFERENCES users(id) NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_activities_competency ON activities(competency_id);
CREATE INDEX IF NOT EXISTS idx_activities_grade ON activities(grade);
CREATE INDEX IF NOT EXISTS idx_rubric_submissions_student ON rubric_submissions(student_id);
CREATE INDEX IF NOT EXISTS idx_rubric_submissions_activity ON rubric_submissions(activity_id);
CREATE INDEX IF NOT EXISTS idx_exam_questions_paper ON exam_questions(paper_id);
CREATE INDEX IF NOT EXISTS idx_learning_outcomes_competency ON learning_outcomes(competency_id);
CREATE INDEX IF NOT EXISTS idx_learning_outcomes_grade ON learning_outcomes(grade);
...
DROP TRIGGER IF EXISTS update_curricular_goals_updated_at ON curricular_goals;
...
DROP TRIGGER IF EXISTS update_lo_rubric_descriptors_updated_at ON lo_rubric_descriptors;
...
DROP TRIGGER IF EXISTS update_activity_rubrics_updated_at ON activity_rubrics;
...
DROP TRIGGER IF EXISTS update_chapter_terms_updated_at ON chapter_terms;
...
DROP TRIGGER IF EXISTS update_rubric_submissions_updated_at ON rubric_submissions;
...
DROP TRIGGER IF EXISTS update_self_reflections_updated_at ON self_reflections;
...
DROP TRIGGER IF EXISTS update_teacher_feedback_updated_at ON teacher_feedback;
...
DROP TRIGGER IF EXISTS update_term_summaries_updated_at ON term_summaries;
...
DROP TRIGGER IF EXISTS update_part_a_students_updated_at ON part_a_students;
...
DROP TRIGGER IF EXISTS update_part_a4_parents_updated_at ON part_a4_parents;
