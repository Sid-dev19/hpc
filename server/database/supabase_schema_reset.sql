-- Supabase Schema Reset Script
-- This will drop all existing tables and recreate them

-- Drop tables in correct order (respecting foreign key dependencies)
DROP TABLE IF EXISTS exam_questions CASCADE;
DROP TABLE IF EXISTS exam_papers CASCADE;
DROP TABLE IF EXISTS part_a4_parents CASCADE;
DROP TABLE IF EXISTS part_a_students CASCADE;
DROP TABLE IF EXISTS term_summaries CASCADE;
DROP TABLE IF EXISTS teacher_feedback CASCADE;
DROP TABLE IF EXISTS self_reflections CASCADE;
DROP TABLE IF EXISTS rubric_submissions CASCADE;
DROP TABLE IF EXISTS chapter_terms CASCADE;
DROP TABLE IF EXISTS activity_rubrics CASCADE;
DROP TABLE IF EXISTS activities CASCADE;
DROP TABLE IF EXISTS lo_rubric_descriptors CASCADE;
DROP TABLE IF EXISTS learning_outcomes CASCADE;
DROP TABLE IF EXISTS competencies CASCADE;
DROP TABLE IF EXISTS curricular_goals CASCADE;
...
-- Now recreate all tables (same as original schema)
